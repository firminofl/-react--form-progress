...
function App() {
    ...
    const calculateProgress = () => {
        const itemsInForm = Object.keys(data).length;
        let progress = 0;
        let valueToAdd = 100/itemsInForm; // 100% dividido pela quantidade de itens no formulário
        ...
        <div className='App'>
            ...
            <main>
                ...
                <div className='form-group'>
                    ...
                    <input name={'cpf'} value={data.cpf} onChange={handleChange}/>
                </div>
                <div className='form-group'>
            ...
            <span>
              <input type='radio' name={'genre'} value={'masculino'} onChange={handleChange}
                     checked={data.genre === 'masculino'}/> Masculino
            </span>
                        <span>
              <input type='radio' name={'genre'} value={'feminino'} onChange={handleChange}
